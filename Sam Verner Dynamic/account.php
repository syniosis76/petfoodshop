...
<head>
    <meta charset="UTF-8">
    <title>Account</title>
    <link href="CSS/account.css" rel="stylesheet">  <!--css input-->
...
<body>
    ...
    <div class="content">
        ...
        <div class="header-image">
            ...
            <img src="pics/login.png" class="signup-text">
        </div>
        <div class="inputs">
            ...
            <div class="login-button-background">
                <a href="profile-settings.html" class="login-button">Login</a>
            </div>
            <div class="no-account">
                <a href="signup.html" class="no-account-text">No account? Sign up here!</a>
            </div>
        </div>
    </div>    
