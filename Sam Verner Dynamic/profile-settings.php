...
<head>
    ...
    <link href="CSS/profile-settings.css" rel="stylesheet"> <!--css input-->
...
<body>
    ...
    <div class="content">
        ...
        <div class="header-image">
            ...
            <img src="pics/profilesettings.png" class="signup-text">
        </div>
        <div class="inputs">
            <input type="text" class="first-name" placeholder="First Name" readonly>    <!--content inputs-->
            <input type="text" class="last-name" placeholder="Last Name" readonly><br>
